...
public class ConversionTest {
	...
	public void vectorToNTest() {
		// 0 = 0,0,0
		assertArrayEquals(new int[] { 0, 0, 0, 0 }, Conversion.vectorToNBlock(new double[][] { Transformations3D.V000,
				Transformations3D.V000, Transformations3D.V000, Transformations3D.V000 }));
		assertArrayEquals(new int[] { 1, 1, 1, 1 }, Conversion.vectorToNBlock(new double[][] { Transformations3D.V100,
